...
/**
 * Immutable summary of a completed solve, printed once after the live dashboard closes.
 * Decoupled from live solver scope objects so that {@link DashboardRenderer#renderFinalSummary}
