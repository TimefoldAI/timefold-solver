...
** xref:quickstart/service/getting-started.adoc[Service Quickstart (Preview)]
** Embed as a library
...
** xref:service/overview.adoc[Service Reference (Preview)]
...
** xref:running-timefold-solver/library-integration.adoc[Use as a Library (Advanced)]
