...
** This is common in xref:design-patterns/responding-to-change.adoc#multiStagePlanning[multi-stage planning],
...
use a xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variable] to calculate the time.

This pattern is implemented using the xref:design-patterns/modeling-planning-problems.adoc#planningListVariable[planning list variable].
...
The starting time of an element is usually a xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variable].
...
Implement the automatic collapse in the xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variables]
...
Implement the automatic delay in the xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variables]
