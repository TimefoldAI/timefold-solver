...
If instead you are looking for guidance on how to create a good domain model, read the xref:design-patterns/domain-modeling.adoc[domain modeling guide].
...
For more detailed guidance on when to use which variant, read the xref:design-patterns/domain-modeling.adoc#domainModelingGuide[domain modeling guide].
...
and xref:design-patterns/responding-to-change.adoc#realTimePlanning[real-time planning]),
...
See the xref:design-patterns/responding-to-change.adoc#overconstrainedPlanningWithNullValues[overconstrained planning with `null` variable values] section in the docs for more infomation.
====


xref:design-patterns/responding-to-change.adoc[Repeated planning]
(especially xref:design-patterns/responding-to-change.adoc#realTimePlanning[real-time planning])
...
use xref:design-patterns/responding-to-change.adoc#problemChange[ProblemChange].
...
In an xref:design-patterns/responding-to-change.adoc#overconstrainedPlanning[over-constrained use case],
...
This also helps reduce the overhead of the xref:design-patterns/modeling-planning-problems.adoc#cloningASolution[solution cloning],
...
If the model uses a xref:design-patterns/modeling-planning-problems#planningListVariable[list variable],
...
If both xref:design-patterns/modeling-planning-problems.adoc#planningVariable[basic] and xref:design-patterns/modeling-planning-problems#planningListVariable[list] variables are included in the model,
