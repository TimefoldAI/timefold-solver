...
. *If there are multiple relationships (or fields), check for xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variables]*.
...
The other side will become an xref:design-patterns/modeling-planning-problems.adoc#bidirectionalVariable[inverse relation shadow variable] later on.
...
xref:design-patterns/modeling-planning-problems.adoc#planningListVariable[Planning list variable] is not a means of achieving a many-to-one relationship;
