...
This guide provides reusable solutions to common challenges when modeling a planning problem.
Follow these guidelines to create a well thought-out model that can contribute significantly to the success of your planning.

[#domainModelingGuidelines]
...
. *If the goal is to find an optimal order of elements*, use the xref:design-patterns/time-patterns.adoc#chainedThroughTimePattern[Chained Through Time pattern].
