...
. Add a score level (usually a medium level between the hard and soft level) by switching xref:constraints-and-score/constraints-and-score.adoc#scoreType[`Score` type].
...
. Add an additional score level (usually a medium level between the hard and soft level) by switching xref:constraints-and-score/constraints-and-score.adoc#scoreType[`Score` type].
