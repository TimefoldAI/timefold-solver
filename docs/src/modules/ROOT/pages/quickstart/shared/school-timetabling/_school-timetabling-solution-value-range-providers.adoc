...
by matching the type of the planning variable with the type returned by the xref:domain-modeling/modeling-planning-problems.adoc#planningValueRangeProvider[value range provider].
