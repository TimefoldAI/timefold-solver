...
:imagesdir: ../..
ifndef::score-class[:score-class: HardSoftScore]
...
use the `{score-class}` class to represent the score:
...
import ai.timefold.solver.core.api.score.{score-class};
