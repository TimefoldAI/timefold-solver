...
Timefold Solver uses the variable type to connect to a xref:domain-modeling/modeling-planning-problems.adoc#planningValueRangeProvider[value range provider]
