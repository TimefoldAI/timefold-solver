...
Timefold Solver uses the variable type to connect to a xref:design-patterns/modeling-planning-problems.adoc#planningValueRangeProvider[value range provider]
