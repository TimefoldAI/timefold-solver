...
object TimetableApp {
    ...
    fun generateDemoData(demoData: DemoData): Timetable {
        ...
        if (demoData == DemoData.LARGE) {
            timeslots.add(Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
            timeslots.add(Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
            timeslots.add(Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
            timeslots.add(Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
            timeslots.add(Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
            timeslots.add(Timeslot(DayOfWeek.THURSDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
            timeslots.add(Timeslot(DayOfWeek.THURSDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
            timeslots.add(Timeslot(DayOfWeek.THURSDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
            timeslots.add(Timeslot(DayOfWeek.THURSDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
            timeslots.add(Timeslot(DayOfWeek.THURSDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
            timeslots.add(Timeslot(DayOfWeek.FRIDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
            timeslots.add(Timeslot(DayOfWeek.FRIDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
            timeslots.add(Timeslot(DayOfWeek.FRIDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
            timeslots.add(Timeslot(DayOfWeek.FRIDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
            timeslots.add(Timeslot(DayOfWeek.FRIDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
        }
        ...
        var nextLessonId = 0L
        lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Chemistry", "M. Curie", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Biology", "C. Darwin", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "English", "I. Jones", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "English", "I. Jones", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Spanish", "P. Cruz", "9th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Spanish", "P. Cruz", "9th grade"))
        if (demoData == DemoData.LARGE) {
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "ICT", "A. Turing", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Geography", "C. Darwin", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Geology", "C. Darwin", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "I. Jones", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Drama", "I. Jones", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "9th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "9th grade"))
        }

        lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Chemistry", "M. Curie", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "French", "M. Curie", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Geography", "C. Darwin", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "10th grade"))
        lessons.add(Lesson(Long.toString(nextLessonId++), "Spanish", "P. Cruz", "10th grade"))
        if (demoData == DemoData.LARGE) {
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "ICT", "A. Turing", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Biology", "C. Darwin", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Geology", "C. Darwin", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Drama", "I. Jones", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "10th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "10th grade"))

            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "ICT", "A. Turing", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Chemistry", "M. Curie", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "French", "M. Curie", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Geography", "C. Darwin", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Biology", "C. Darwin", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Geology", "C. Darwin", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Spanish", "P. Cruz", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Drama", "P. Cruz", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "11th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "11th grade"))

            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Math", "A. Turing", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "ICT", "A. Turing", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Chemistry", "M. Curie", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "French", "M. Curie", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physics", "M. Curie", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Geography", "C. Darwin", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Biology", "C. Darwin", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Geology", "C. Darwin", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "History", "I. Jones", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "English", "P. Cruz", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Spanish", "P. Cruz", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Drama", "P. Cruz", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Art", "S. Dali", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId++), "Physical education", "C. Lewis", "12th grade"))
            lessons.add(Lesson(Long.toString(nextLessonId), "Physical education", "C. Lewis", "12th grade"))
        }
