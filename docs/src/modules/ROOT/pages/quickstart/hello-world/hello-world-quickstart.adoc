...
* A xref:running-timefold-solver/multithreaded-solving.adoc#logging[logging] implementation, such as `logback-classic` (runtime scope), to see what Timefold Solver is doing.
...
----
  <assembly xmlns="https://maven.apache.org/ASSEMBLY/2.1.0"
            ...
            xsi:schemaLocation="https://maven.apache.org/ASSEMBLY/2.1.0 http://maven.apache.org/xsd/assembly-2.1.0.xsd">
