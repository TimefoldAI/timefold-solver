...
by matching the type of the planning list variable with the type returned by the xref:running-timefold-solver/modeling-planning-problems.adoc#planningValueRangeProvider[value range provider].
