...
:icons: font
:relevance: both
:notes: Mostly irrelevant in [MDK].
...
NOTE: This feature is independent of xref:using-timefold-solver/running-the-solver.adoc#multithreadedIncrementalSolving[multi-threaded incremental solving]
