...
The `Solver` intelligently wades through xref:optimization-algorithms/optimization-algorithms.adoc#searchSpaceSize[the search space] of possible solutions
...
xref:optimization-algorithms/optimization-algorithms.adoc#doesTimefoldFindTheOptimalSolution[that best solution might or might not be an optimal solution].
...
INFO  Construction Heuristic phase (0) ended: time spent (53), best score (-2hard/-1soft), score calculation speed (1066/sec), step total (4).
...
...
INFO  Local Search phase (1) ended: time spent (100), best score (0hard/1soft), score calculation speed (2021/sec), step total (59).
INFO  Solving ended: time spent (100), best score (0hard/1soft), score calculation speed (1100/sec), phase total (2), environment mode (REPRODUCIBLE), move thread count (NONE).
----
