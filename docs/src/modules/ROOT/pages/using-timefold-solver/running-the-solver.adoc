...
* Combining a time gradient dependent algorithm (most notably Simulated Annealing) together with <<timeMillisSpentTermination,time spent termination>>.
...
[#environmentModeRecommendations]
=== Best practices
