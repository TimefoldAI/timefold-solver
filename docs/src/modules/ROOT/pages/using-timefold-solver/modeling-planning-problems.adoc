...
- xref:basicPlanningVariable[@PlanningVariable]: contains a single *planning value*. *Planning values* can be assigned to multiple *planning entities*.
...
Depending on your use of xref:basicPlanningVariable[@PlanningVariable], xref:planningListVariable[@PlanningListVariable] or the xref:chainedPlanningVariable[Chained @PlanningVariable]
...
- Genuine planning variable is set to `null`, but it <<basicVariableAllowingUnassigned,allows unassigned values>>.
...
[#basicVariableAllowingUnassigned]
...
not even for a <<basicVariableAllowingUnassigned,planning variable allowing unassigned values>>.
====
