...
Testing the logic of shadow variables is crucial for maintaining consistency and preventing issues such as xref:constraint-and-score/overview.adoc#invalidScoreDetection[score corruption].
