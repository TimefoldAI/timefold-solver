...
NOTE: This approach does not allow pinning of the individual variables. If that is something your use case requires, you'll need xref:#mixedModelsMultipleEntities[multiple entities].
