...
|"variableName"
|Refers to a variable (genuine or shadow) on the same planning entity. A planning list variable cannot be a source and fails fast, since the supplier would not be updated when the list variable or the shadow variables of its elements change.
