...
See the xref:domain-modeling/overconstrained-planning.adoc[overconstrained planning] guide for more information.
====
...
In an xref:domain-modeling/overconstrained-planning.adoc[over-constrained use case],
