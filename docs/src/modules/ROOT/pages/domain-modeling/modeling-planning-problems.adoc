...
If both xref:domain-modeling/modeling-planning-problems.adoc#planningVariable[basic] and xref:domain-modeling/modeling-planning-problems#planningListVariable[list] variables are included in the model,
