[#commonPatterns]
= Common patterns
:page-aliases: design-patterns/design-patterns.adoc
:doctype: book
:sectnums:
:icons: font
...
[NOTE]
====
This page covers patterns you will encounter while designing your domain model.
It is best read alongside the xref:domain-modeling/domain-modeling.adoc[domain modeling guide], not after, especially the time assignment section if your problem involves scheduling tasks in time.
====

[#timeRepresentations]
== Choosing a time representation
...
There are several designs for assigning a planning entity to a starting time (or date):
...
** This is common in multi-stage planning,
...
image::domain-modeling/design-patterns/assigningTimeToPlanningEntities.png[align="center"]

image::domain-modeling/design-patterns/assigningTimeToPlanningEntities2.png[align="center"]
...
image::domain-modeling/design-patterns/chainedThroughTimeAutomaticCollapse.png[align="center"]
...
image::domain-modeling/design-patterns/chainedThroughTimeAutomaticDelayUntilLast.png[align="center"]
...
image::domain-modeling/design-patterns/chainedThroughTimeAutomaticDelayUntilLastLoop.png[align="center"]
