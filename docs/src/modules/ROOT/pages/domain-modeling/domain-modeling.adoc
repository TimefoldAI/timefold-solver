...
. *If the goal is to find an optimal order of elements*, use the xref:domain-modeling/time-patterns.adoc#chainedThroughTimePattern[Chained Through Time pattern].
