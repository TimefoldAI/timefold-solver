...
|                                                    | Time Spent | Of Total |
| :------------------------------------------------- | ---------: | -------: |
| 2: Teacher time efficiency                         |     7.22 s |  26.80 % |
| 6: Room conflict                                   |     3.68 s |  13.66 % |
| 4: Student group conflict                          |     3.51 s |  13.02 % |
| 3: Teacher room stability                          |     3.42 s |  12.68 % |
| 1: Student group subject variety                   |     3.30 s |  12.25 % |
| 5: Teacher conflict                                |     3.21 s |  11.90 % |
| Work shared by 1, 2, 3, 4, 5, 6                    |     2.61 s |   9.68 % |

DEBUG: ## Constraint Profiling Node Breakdown
| 2: Teacher time efficiency                         | Time Spent | Of Total |
| :------------------------------------------------- | ---------: | -------: |
| JOIN Node 7                                        |     1.33 s |  31.09 % |
| JOIN Node 6                                        |     1.28 s |  30.00 % |
...

 - JOIN Node 7 defined at location org.acme.schooltimetabling.solver.TimetableConstraintProvider#teacherTimeEfficiency:77
 - JOIN Node 6 defined at location org.acme.schooltimetabling.solver.TimetableConstraintProvider#teacherTimeEfficiency:77
...

TRACE: ## Constraint Profiling Lifecycle Breakdown
| 2: Teacher time efficiency               |  INSERT  |  UPDATE  |  RETRACT  |
| :--------------------------------------- | -------: | -------: | --------: |
| JOIN                                     |  11.17 % |  79.50 % |    9.33 % |
...
----
