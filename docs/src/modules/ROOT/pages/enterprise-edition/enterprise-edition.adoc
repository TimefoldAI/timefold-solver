...
|                                                    | Time Spent | Of Total |
| :------------------------------------------------- | ---------: | -------: |
| 2: Teacher time efficiency                         |     7.08 s |  26.12 % |
| 4: Student group conflict                          |     3.77 s |  13.91 % |
| 6: Room conflict                                   |     3.63 s |  13.40 % |
| 5: Teacher conflict                                |     3.40 s |  12.56 % |
| 3: Teacher room stability                          |     3.35 s |  12.38 % |
| 1: Student group subject variety                   |     3.28 s |  12.09 % |
| Work shared by 1, 2, 3, 4, 5, 6                    |     2.58 s |   9.53 % |

DEBUG: ## Constraint Profiling Node Breakdown
| 2: Teacher time efficiency                         | Time Spent | Of Total |
| :------------------------------------------------- | ---------: | -------: |
| JOIN Node 26                                       |     1.73 s |  40.10 % |
| JOIN Right Input 7                                 |     1.30 s |  30.19 % |
| JOIN Left Input 6                                  |     1.28 s |  29.71 % |
| FILTER 5                                           |     2.21 s | 100.00 % |
| SCORING 4                                          |     0.56 s | 100.00 % |
...
| :--------------------------------------- | -------: | -------: | --------: |
| JOIN                                     |  10.91 % |  77.96 % |   11.13 % |
| FILTER                                   |  26.48 % |  48.56 % |   24.96 % |
| SCORING                                  |  12.21 % |  17.74 % |   70.05 % |
