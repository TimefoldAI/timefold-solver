...
[WARNING]
====
Models with xref:using-timefold-solver/modeling-planning-problems.adoc#chainedPlanningVariable[chained variables] or xref:using-timefold-solver/modeling-planning-problems.adoc#mixedModels[mixed models] cannot apply the partitioned search method.
====
...
or the solver may fail to optimize the problem.
====
