...
[WARNING]
====
Models with xref:using-timefold-solver/modeling-planning-problems.adoc#chainedPlanningVariable[chained variables] or xref:using-timefold-solver/modeling-planning-problems.adoc#mixedModels[mixed models] cannot apply the partition search method.
====
...
[WARNING]
====
When working with a model that includes a xref:using-timefold-solver/modeling-planning-problems.adoc#planningListVariable[list variable],
it's essential to remember that a xref:using-timefold-solver/modeling-planning-problems.adoc#planningValue[planning value] can be assigned to only one xref:using-timefold-solver/modeling-planning-problems.adoc#planningEntity[entity].
Therefore,
ensure that your partitioner returns distinct value lists for each entity
or the solver may fail to optimize the partitions.
====
