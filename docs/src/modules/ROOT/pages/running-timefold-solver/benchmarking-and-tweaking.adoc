[#benchmarker]
= Benchmarking
:page-aliases: benchmarking-and-tweaking/benchmarking-and-tweaking.adoc, using-timefold-solver/benchmarking-and-tweaking.adoc
:doctype: book
:sectnums:
:icons: font
...
image::running-timefold-solver/benchmarking-and-tweaking/benchmarkOverview.png[align="center"]
...
[IMPORTANT]
====
A solver configuration in a benchmark cannot override `environmentMode` in any of its phases,
even though xref:running-timefold-solver/solver-diagnostics.adoc#environmentMode[the solver] allows it.
====
...
Benchmark logging is configured like xref:running-timefold-solver/solver-diagnostics.adoc#logging[solver logging].
...
image::running-timefold-solver/benchmarking-and-tweaking/bestScoreSummary.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/bestScoreDistributionSummary.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/bestScoreStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/letTheBestScoreStatisticGuideYou.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/stepScoreStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/scoreCalculationSpeedStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/moveEvaluationSpeedStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/moveCountPerTypeStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/bestSolutionMutationStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/moveCountPerStepStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/memoryUseStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/constraintMatchTotalBestScoreStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/constraintMatchTotalStepScoreStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/pickedMoveTypeBestScoreDiffStatistic.png[align="center"]
...
image::running-timefold-solver/benchmarking-and-tweaking/pickedMoveTypeStepScoreDiffStatistic.png[align="center"]
...
NOTE: This feature is independent of xref:running-timefold-solver/multithreaded-solving.adoc#multithreadedIncrementalSolving[multi-threaded incremental solving]
and can be used in the open source version of Timefold Solver.
...
the benchmarker will automatically use a _different_ xref:running-timefold-solver/solver-diagnostics.adoc#randomNumberGenerator[`Random` seed] for every sub single run,
without losing reproducibility (for each sub single index) in xref:running-timefold-solver/solver-diagnostics.adoc#environmentMode[EnvironmentMode] ``NO_ASSERT`` and lower.
====
...
image::running-timefold-solver/benchmarking-and-tweaking/benchmarkAggregator.png[align="center"]
...
Summarize a too verbose report:: Select only the interesting solver benchmarks from the existing report. This is especially useful on template reports to make the graphs readable.
...
image::running-timefold-solver/benchmarking-and-tweaking/benchmarkAggregatorScreenshot.png[align="center"]
...
NOTE: All the input reports which are being merged should have been generated with the same Timefold Solver version as the `BenchmarkAggregator`.
Using reports from different Timefold Solver major or minor versions are not guaranteed to succeed and deliver correct information,
