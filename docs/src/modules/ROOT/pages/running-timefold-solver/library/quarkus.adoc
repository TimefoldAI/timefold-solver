...
public class BeanProducer {
    ...
    @Produces
    @Default
    public SolverManager<EmployeeSchedule, String> overrideSolverManager(SolverFactory<EmployeeSchedule> solverFactory) {
...
class BeanProducer {
    ...
    @Produces
    @Default
    fun overrideSolverManager(solverFactory: SolverFactory<EmployeeSchedule>?): SolverManager<EmployeeSchedule, String> {
...
class Resource {
    ...
    private lateinit var fastSolver: SolverManager<Timetable, String>
    private lateinit var regularSolver: SolverManager<Timetable, String>
