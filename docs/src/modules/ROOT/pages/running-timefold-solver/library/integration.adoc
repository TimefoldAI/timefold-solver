...
xref:running-timefold-solver/library/quarkus.adoc[Quarkus]
and xref:running-timefold-solver/library/spring-boot.adoc[Spring Boot].
...
image::running-timefold-solver/library/integrationOverview.png[align="center"]
