...
If the run is already in a terminal state (`SOLVING_COMPLETED`, `SOLVING_FAILED`, `SOLVING_INCOMPLETE`, or `DATASET_INVALID`) when you connect, the service returns HTTP 410 Gone.
