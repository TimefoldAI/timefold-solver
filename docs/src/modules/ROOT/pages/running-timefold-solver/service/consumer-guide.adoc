...
If omitted, the service uses its configured default termination (for example, from application configuration)
...
The service responds with HTTP 202 (Accepted) and the initial solving response envelope.
