[#serviceOverview]
= Building a service
:page-aliases: service/overview.adoc
...
See xref:running-timefold-solver/service/rest-api.adoc[REST API] for the full endpoint reference and request/response formats.
