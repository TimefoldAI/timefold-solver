...
The xref:./map-service.adoc[map service] is a good example of this: it enriches
`LocationsAwareSolverModel` implementations with a travel time and distance matrix before every
solve, without any code in your model calling it directly.
