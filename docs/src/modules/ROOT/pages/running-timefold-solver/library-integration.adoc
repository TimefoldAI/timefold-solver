...
The returned instance is most likely xref:design-patterns/modeling-planning-problems.adoc#cloningASolution[a planning clone] of the input.
====

NOTE: The input may be partially or fully initialized, which is common in xref:design-patterns/responding-to-change.adoc[repeated planning].
