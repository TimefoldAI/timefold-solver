...
This also helps reduce the overhead of the xref:running-timefold-solver/modeling-planning-problems.adoc#cloningASolution[solution cloning],
...
If the model uses a xref:running-timefold-solver/modeling-planning-problems#planningListVariable[list variable],
...
If both xref:running-timefold-solver/modeling-planning-problems.adoc#planningVariable[basic] and xref:running-timefold-solver/modeling-planning-problems#planningListVariable[list] variables are included in the model,
