...
by xref:design-patterns/modeling-planning-problems.adoc#planningId[adding a `@PlanningId` annotation]
...
Also xref:design-patterns/modeling-planning-problems.adoc#planningId[add a `@PlanningId` annotation]
on every planning entity class and planning value class.
