...
This constraint stream iterates over all instances of class `Shift` in the xref:design-patterns/modeling-planning-problems.adoc#problemFacts[problem facts] and
xref:design-patterns/modeling-planning-problems.adoc#planningEntity[planning entities]
in the xref:design-patterns/modeling-planning-problems.adoc#planningProblemAndPlanningSolution[planning problem].
...
is in a xref:design-patterns/modeling-planning-problems.adoc#problemFacts[problem fact collection]
or a xref:design-patterns/modeling-planning-problems.adoc#planningEntitiesOfASolution[planning entity collection]
that is xref:design-patterns/modeling-planning-problems.adoc#detectingInconsistencies[consistent]
and has no `null` genuine planning variables.

To include instances with a `null` xref:design-patterns/modeling-planning-problems.adoc#planningVariable[genuine planning variable],
or planning values
not assigned to any xref:design-patterns/modeling-planning-problems.adoc#planningListVariable[planning list variable],
...
In cases utilizing the xref:design-patterns/modeling-planning-problems.adoc#planningListVariable[planning list variable],
you may want
to include an xref:design-patterns/modeling-planning-problems.adoc#listVariableShadowVariablesInverseRelation[inverse relation shadow variable]
...
The purpose of constraint streams is to build up a xref:constraints-and-score/overview.adoc#whatIsAScore[score] for a xref:design-patterns/modeling-planning-problems.adoc#planningProblemAndPlanningSolution[solution].
...
that calling `givenSolution(...)` does not update any xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variables].
...
To test all constraints while updating all xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variables],
