...
ConstraintStreams API also has advanced support for xref:constraints-and-score/constraints-and-score.adoc#explainingTheScore[score explanation] through xref:constraintStreamsCustomizingJustificationsAndIndictments[custom justifications and indictments].
