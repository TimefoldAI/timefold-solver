...
* If you use Timefold Solver's xref:integration/quarkus.adoc#integrationWithQuarkus[Quarkus integration],
* or if you use Timefold Solver's xref:integration/spring-boot.adoc#integrationWithSpringBoot[Spring Boot integration],
