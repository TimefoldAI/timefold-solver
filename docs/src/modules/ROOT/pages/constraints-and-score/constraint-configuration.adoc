...
The field will be automatically exposed as a xref:design-patterns/modeling-planning-problems.adoc#problemFacts[problem fact],
...
This will expose the `ConstraintParameters` as a xref:design-patterns/modeling-planning-problems.adoc#problemFacts[problem fact],
