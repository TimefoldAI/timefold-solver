...
Fast and scalable.
* **xref:constraints-and-score/score-calculation.adoc#incrementalJavaScoreCalculation[Incremental Java/Python score calculation]** (not recommended):
...
* **xref:constraints-and-score/score-calculation.adoc#easyJavaScoreCalculation[Easy Java/Python score calculation]** (not recommended):
