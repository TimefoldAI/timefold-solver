...
To instead leave some of the planning entities unassigned, apply xref:design-patterns/responding-to-change.adoc#overconstrainedPlanning[overconstrained planning].
====
...
To update planning entities when the planning variable change, use xref:design-patterns/modeling-planning-problems.adoc#shadowVariable[shadow variables] instead.
====
