...
If you are using the xref:commercial-editions/commercial-editions.adoc[Enterprise Edition], you should xref:commercial-editions/commercial-editions.adoc#automaticNodeSharing[enable automatic node sharing] as it can significantly speed up score calculation.
...
xref:constraints-and-score/score-calculation.adoc#constraintStreams[Constraint streams] have builtin support for xref:commercial-editions/commercial-editions.adoc#constraintProfiling[profiling constraints].
