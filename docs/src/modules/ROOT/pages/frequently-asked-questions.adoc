...
Because they are xref:design-patterns/modeling-planning-problems.adoc#pinnedPlanningEntities[pinned],
...
(except in xref:design-patterns/responding-to-change.adoc#daemon[daemon mode]
