...
This section explains how to update your planning model to use the new declarative xref:domain-modeling/modeling-planning-problems.adoc#customShadowVariable[custom shadow variable]
...
Read the xref:domain-modeling/modeling-planning-problems.adoc#shadowSourcesPaths[full @ShadowSources reference here].
...
* xref:domain-modeling/modeling-planning-problems.adoc#customShadowVariable[Custom shadow variables]
* xref:domain-modeling/modeling-planning-problems.adoc#shadowSourcesPaths[@ShadowSources paths]