...
This section explains how to update your planning model to use the new declarative xref:design-patterns/modeling-planning-problems.adoc#customShadowVariable[custom shadow variable]
...
Read the xref:design-patterns/modeling-planning-problems.adoc#shadowSourcesPaths[full @ShadowSources reference here].
...
* xref:design-patterns/modeling-planning-problems.adoc#customShadowVariable[Custom shadow variables]
* xref:design-patterns/modeling-planning-problems.adoc#shadowSourcesPaths[@ShadowSources paths]