...
Please use xref:running-timefold-solver/constraint-overrides.adoc#definingAndOverridingConstraintWeights[constraint weight overrides] instead.
...
Users of xref:running-timefold-solver/library-integration.adoc#throttlingBestSolutionEvents[solution throttling]
