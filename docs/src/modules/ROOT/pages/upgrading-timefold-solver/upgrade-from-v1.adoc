...
`LookupStrategyType` was used in xref:commercial-editions/commercial-editions.adoc#multithreadedIncrementalSolving[multi-threaded incremental solving]
...
Users of xref:commercial-editions/commercial-editions.adoc#throttlingBestSolutionEvents[solution throttling]
