...
Variable listeners were deprecated since 1.26.0 in favor of xref:design-patterns/modeling-planning-problems.adoc#customShadowVariable[custom shadow variables].
...
and replaced it with xref:design-patterns/modeling-planning-problems.adoc#pinnedPlanningEntities[`@PlanningPin` annotation] instead.
====
...
that the solver would look up entities by their xref:design-patterns/modeling-planning-problems.adoc#planningId[planning ID].
