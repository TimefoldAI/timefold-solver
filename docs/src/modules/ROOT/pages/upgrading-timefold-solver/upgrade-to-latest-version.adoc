...
We invite you to read the xref:using-timefold-solver/modeling-planning-problems.adoc#planningListVariable[list variable documentation],
study the xref:quickstart/quarkus-vehicle-routing/quarkus-vehicle-routing-quickstart.adoc[Vehicle Routing quickstart] as an example implementation,
and reach out to us for help should you find yourself stuck.
====
