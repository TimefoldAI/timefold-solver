...
[%collapsible%open]
====
With the introduction of custom shadow variables,
we have deprecated the variable listener mechanism
and we will be removing support for it entirely in Timefold Solver 2.0.
