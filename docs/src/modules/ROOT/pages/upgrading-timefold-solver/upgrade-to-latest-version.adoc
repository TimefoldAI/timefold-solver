...
[%collapsible%open]
====
Inheritance is a feature that is already available for modeling planning solutions and planning entities.
The new solver version has clarified the inheritance rules
and provides updated documentation on how to use it for both the
