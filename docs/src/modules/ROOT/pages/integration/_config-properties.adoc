...
Enable xref:using-timefold-solver/running-the-solver.adoc#multithreadedIncrementalSolving[multithreaded incremental solving] for a single problem, which increases CPU consumption.
Defaults to `NONE`.
