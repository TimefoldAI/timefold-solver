...
. Next,
implement xref:design-patterns/modeling-planning-problems.adoc#planningEntitySorting[planning entity sorting]
...
This is especially common during xref:design-patterns/responding-to-change.adoc#realTimePlanning[real-time planning].
====
...
which may have been xref:design-patterns/modeling-planning-problems.adoc#cloningASolution[planning-cloned] since.
...
read about xref:design-patterns/responding-to-change.adoc[repeated planning]
and use xref:design-patterns/responding-to-change.adoc#problemChange[ProblemChange] instead.
...
add the `customProperties` element and use xref:running-timefold-solver/configuration.adoc#customPropertiesConfiguration[custom properties]:
