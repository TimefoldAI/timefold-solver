...
This is especially common during xref:how-to/real-time-planning.adoc[real-time planning].
====
...
read about xref:domain-modeling/responding-to-change.adoc[repeated planning]
and use xref:how-to/real-time-planning.adoc#problemChange[ProblemChange] instead.
