...
This is only necessary when the solver is configured to use xref:commercial-editions/commercial-editions.adoc#multithreadedSolving[multi-threaded solving].
`String describe()`::
