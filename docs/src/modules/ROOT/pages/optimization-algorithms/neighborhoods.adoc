...
Move a contiguous block of values to another position, optionally reversing the order of the range,
swap two such ranges, unassign a whole range at once,
or reverse a range in place, which is the classic route-improvement move.
