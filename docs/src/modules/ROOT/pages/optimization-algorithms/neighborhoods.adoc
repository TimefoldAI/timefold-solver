...
It further specializes into `PlanningVariableMetaModel` for a xref:design-patterns/modeling-planning-problems.adoc#planningVariable[basic planning variable],
`PlanningListVariableMetaModel` for a xref:design-patterns/modeling-planning-problems.adoc#planningListVariable[list variable],
and `ShadowVariableMetaModel` for a xref:design-patterns/modeling-planning-problems.adoc#shadowPlanningVariables[shadow variable].
...
The following example shows a simple move implementation which changes the value of a xref:design-patterns/modeling-planning-problems.adoc#planningVariable[basic planning variable],
...
`ChangeMove`:: Changes the value of a xref:design-patterns/modeling-planning-problems.adoc#planningVariable[basic planning variable] on a planning entity.
`SwapMove`:: Swaps the values of a xref:design-patterns/modeling-planning-problems.adoc#planningVariable[basic planning variable] between two planning entities.
`ListChangeMove`:: Changes the position of a value in the xref:design-patterns/modeling-planning-problems.adoc#planningListVariable[list variable] of a planning entity.
`ListSwapMove`:: Swaps xref:design-patterns/modeling-planning-problems.adoc#planningListVariable[list variable] elements between planning entities.
