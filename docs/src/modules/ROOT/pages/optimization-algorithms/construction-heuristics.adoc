...
It sorts the planning entities in descending order and the planning values in ascending order based on specified metrics.
...
It sorts the planning entities and the planning values in descending order based on specified metrics.
