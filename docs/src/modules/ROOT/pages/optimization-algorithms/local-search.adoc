[#localSearch]
= Local search
:page-aliases: olocal-search/local-search.adoc
:doctype: book
:sectnums:
:icons: font
...
[IMPORTANT]
====
When using move tabu and undo move tabu with xref:optimization-algorithms/overview.adoc#customMoves[custom moves],
