...
* ``DESCENDING``: Evaluate the planning values in descending order based on a given metric. Requires the model to support xref:design-patterns/modeling-planning-problems.adoc#planningValueSorting[planning value sorting].
