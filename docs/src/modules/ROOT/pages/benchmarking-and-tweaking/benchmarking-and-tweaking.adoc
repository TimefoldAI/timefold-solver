...
potential xref:constraints-and-score/constraints-and-score.adoc#scoreTrap[score trap] which gets the solver temporarily stuck in a local optima.*
...
Requires the score calculation to support xref:constraints-and-score/constraints-and-score.adoc#explainingTheScore[constraint matches].
xref:constraints-and-score/constraints-and-score.adoc#constraintStreams[Constraint Streams] supports constraint matches automatically,
but xref:constraints-and-score/constraints-and-score.adoc#incrementalJavaScoreCalculation[incremental Java score calculation] requires more work.
...
Also requires the score calculation to support xref:constraints-and-score/constraints-and-score.adoc#explainingTheScore[constraint matches].
