...
|* No
* Defined by us
|* xref:constraints-and-score/constraints-and-score.adoc#fairnessScoreConstraints[Fairness score constraints]
...
|* xref:configuration/configuration.adoc#shadowVariable[Shadow variable]
* xref:responding-to-change/responding-to-change.adoc#realTimePlanning[Real-time planning]
* xref:optimization-algorithms/optimization-algorithms.adoc#nearbySelection[Nearby selection]
* Real road distances
...
* https://neo.lcc.uma.es/vrp/[VRP web]
|* All of Vehicle routing
* Custom xref:configuration/configuration.adoc#customVariableListener[VariableListener]
...
|* xref:constraints-and-score/constraints-and-score.adoc#bendableScore[Bendable score]
* Custom xref:configuration/configuration.adoc#customVariableListener[VariableListener]
* xref:configuration/configuration.adoc#valueRangeFactory[ValueRangeFactory]
