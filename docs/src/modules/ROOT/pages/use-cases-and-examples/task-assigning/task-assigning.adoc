...
** Start with the longest working employee first, then the second longest working employee and so forth, to create xref:constraints-and-score/constraints-and-score.adoc#fairnessScoreConstraints[fairness and load balancing].
