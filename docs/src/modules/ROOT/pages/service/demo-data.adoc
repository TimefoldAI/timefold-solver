...
// To be simplified with: https://github.com/TimefoldAI/timefold-models-sdk/issues/550
...
With this interface implemented, the SDK will automatically expose these methods as REST endpoints:
