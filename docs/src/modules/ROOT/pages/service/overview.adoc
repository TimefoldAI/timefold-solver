...
xref:../running-timefold-solver/modeling-planning-problems.adoc[*Modeling planning problems*]::
How to annotate your domain with `@PlanningSolution`, `@PlanningEntity`, `@PlanningVariable`, and related annotations.
This is identical whether you run as a service or embed as a library.
