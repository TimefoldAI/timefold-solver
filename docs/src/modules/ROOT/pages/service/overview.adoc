...
xref:../using-timefold-solver/modeling-planning-problems.adoc[*Modeling planning problems*]::
...
xref:../using-timefold-solver/running-the-solver.adoc[*Tuning and diagnostics*]::
