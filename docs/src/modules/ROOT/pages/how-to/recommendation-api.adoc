...
With xref:design-patterns/responding-to-change.adoc#realTimePlanning[real-time planning], we can respond to a continuous stream of external changes.
...
This would be an example of xref:design-patterns/responding-to-change.adoc#continuousPlanning[continuous planning].
...
If required, xref:design-patterns/responding-to-change.adoc#continuousPlanning[continuous planning] can be used to optimize the entire solution afterwards.
