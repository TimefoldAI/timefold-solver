...
With xref:how-to/real-time-planning.adoc[real-time planning], we can respond to a continuous stream of external changes.
...
This would be an example of xref:how-to/continuous-planning.adoc[continuous planning].
...
If required, xref:how-to/continuous-planning.adoc[continuous planning] can be used to optimize the entire solution afterwards.
