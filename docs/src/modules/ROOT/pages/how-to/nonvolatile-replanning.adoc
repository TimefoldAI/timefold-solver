...
Use xref:design-patterns/modeling-planning-problems.adoc#pinnedPlanningEntities[`@PlanningPin`] to lock individual entities to their current values,
or xref:design-patterns/modeling-planning-problems.adoc#partiallyPinnedPlanningListVariable[`@PlanningPinToIndex`] to lock only the first portion of a planning list variable.
