...
One of `car` (the default), `bicycle`, `foot`, or `auto-select` to take the transport types from the dataset itself.
See xref:running-timefold-solver/service/model-enrichment.adoc#transportTypes[Transport types].
