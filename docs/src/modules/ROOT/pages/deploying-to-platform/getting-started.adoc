...
If you need your own license, sign up at the xref:commercial-editions/license-management.adoc[Timefold License Manager]: every new account starts with a free, time-limited Enterprise trial, so you can get a working license without contacting sales first.
