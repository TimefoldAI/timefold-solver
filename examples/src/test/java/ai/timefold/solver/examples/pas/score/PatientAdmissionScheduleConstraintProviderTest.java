package ai.timefold.solver.examples.pas.score;
...
import ai.timefold.solver.examples.pas.domain.Department;
import ai.timefold.solver.examples.pas.domain.DepartmentSpecialism;
import ai.timefold.solver.examples.pas.domain.Equipment;
import ai.timefold.solver.examples.pas.domain.Gender;
import ai.timefold.solver.examples.pas.domain.GenderLimitation;
import ai.timefold.solver.examples.pas.domain.Night;
...
import ai.timefold.solver.examples.pas.domain.PreferredPatientEquipment;
import ai.timefold.solver.examples.pas.domain.RequiredPatientEquipment;
import ai.timefold.solver.examples.pas.domain.Room;
import ai.timefold.solver.examples.pas.domain.RoomEquipment;
import ai.timefold.solver.examples.pas.domain.RoomSpecialism;
import ai.timefold.solver.examples.pas.domain.Specialism;
