package ai.timefold.solver.examples.examination.score;
...
import ai.timefold.solver.examples.examination.domain.ExaminationConstraintConfiguration;
...
import ai.timefold.solver.examples.examination.domain.PeriodPenalty;
import ai.timefold.solver.examples.examination.domain.PeriodPenaltyType;
import ai.timefold.solver.examples.examination.domain.Room;
import ai.timefold.solver.examples.examination.domain.RoomPenalty;
import ai.timefold.solver.examples.examination.domain.RoomPenaltyType;
import ai.timefold.solver.examples.examination.domain.Student;
import ai.timefold.solver.examples.examination.domain.Topic;
import ai.timefold.solver.examples.examination.domain.solver.TopicConflict;
