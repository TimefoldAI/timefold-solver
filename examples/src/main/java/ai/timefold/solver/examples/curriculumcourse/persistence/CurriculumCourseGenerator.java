...
import static ai.timefold.solver.examples.common.persistence.AbstractSolutionImporter.getFlooredPossibleSolutionSize;
...
import ai.timefold.solver.examples.curriculumcourse.domain.Day;
import ai.timefold.solver.examples.curriculumcourse.domain.Lecture;
import ai.timefold.solver.examples.curriculumcourse.domain.Period;
import ai.timefold.solver.examples.curriculumcourse.domain.Room;
import ai.timefold.solver.examples.curriculumcourse.domain.Teacher;
import ai.timefold.solver.examples.curriculumcourse.domain.Timeslot;
