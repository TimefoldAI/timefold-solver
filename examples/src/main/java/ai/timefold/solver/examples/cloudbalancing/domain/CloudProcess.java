package ai.timefold.solver.examples.cloudbalancing.domain;

import ai.timefold.solver.core.api.domain.entity.PlanningEntity;
import ai.timefold.solver.core.api.domain.variable.PlanningVariable;
import ai.timefold.solver.examples.cloudbalancing.domain.solver.CloudComputerStrengthComparator;
import ai.timefold.solver.examples.cloudbalancing.domain.solver.CloudProcessDifficultyComparator;
