 ...
 * if the user has registered {@link ai.timefold.solver.jackson2.api.TimefoldJacksonModule}
 ...
 * to {@link ai.timefold.solver.jackson2.api.score.stream.common.SerializableSequence} instances,
 * which can then be directly serialized.
 * During deserialization,
 * the implementation first reads {@link ai.timefold.solver.jackson2.api.score.stream.common.SerializableSequence} instances
 * and then converts them to {@link ai.timefold.solver.jackson2.api.score.stream.common.DeserializableSequence} instances,
