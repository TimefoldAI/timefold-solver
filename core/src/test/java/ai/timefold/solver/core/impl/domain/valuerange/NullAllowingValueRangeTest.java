...
class NullAllowingValueRangeTest {
    ...
    @Test
    void getSize() {
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5, 10))).getSize())
                .isEqualTo(5L);
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(100, 120, 5, 7, 8))).getSize())
                .isEqualTo(6L);
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(-15, 25, 0))).getSize())
                .isEqualTo(4L);
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList("b", "z", "a"))).getSize())
                .isEqualTo(4L);
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Collections.emptyList())).getSize())
                .isEqualTo(1L);
    }

    @Test
    void get() {
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5, 10))).get(0L))
                .isNull();
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5, 10))).get(2L))
                .isEqualTo(2);
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList("b", "z", "a", "c", "g", "d")))
                .get(3L))
                .isEqualTo("a");
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList("b", "z", "a", "c", "g", "d")))
                .get(6L))
    ...
    @Test
    void contains() {
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5, 10))).contains(5))
                .isTrue();
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5, 10))).contains(4))
                .isFalse();
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5, 10))).contains(null))
                .isTrue();
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList("b", "z", "a"))).contains("a"))
                .isTrue();
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList("b", "z", "a"))).contains("n"))
                .isFalse();
        assertThat(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList("b", "z", "a"))).contains(null))
                .isTrue();
    }
    ...
    void createOriginalIterator() {
        ...
        assertAllElementsOfIterator(
                ...
                null, 100, 120, 5, 7, 8);
        assertAllElementsOfIterator(
                new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(-15, 25, 0))).createOriginalIterator(),
                null, -15, 25, 0);
        assertAllElementsOfIterator(
                new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList("b", "z", "a")))
                        .createOriginalIterator(),
                null, "b", "z", "a");
        assertAllElementsOfIterator(new NullAllowingValueRange<>(new ListValueRange<>(Collections.emptyList()))
                .createOriginalIterator(), new String[] { null });
    }

    @Test
    void createRandomIterator() {
        assertElementsOfIterator(new NullAllowingValueRange<>(new ListValueRange<>(Arrays.asList(0, 2, 5)))
                .createRandomIterator(new TestRandom(3, 2, 1, 0)), 5, 2, 0, null);
        assertElementsOfIterator(new NullAllowingValueRange<>(new ListValueRange<>(Collections.emptyList()))
