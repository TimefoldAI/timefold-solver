 ...
 */
public class TestdataBoxedPinnedWithIndexDistanceMeter
        implements NearbyDistanceMeter<TestdataBoxedPinnedWithIndexListValue, TestdataObject> {

    @Override
    public double getNearbyDistance(TestdataBoxedPinnedWithIndexListValue origin, TestdataObject destination) {
