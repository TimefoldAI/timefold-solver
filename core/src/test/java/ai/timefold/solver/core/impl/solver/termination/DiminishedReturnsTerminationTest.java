...
class DiminishedReturnsTerminationTest {
    ...
    void testNoImprovementInGraceTerminates() {
        ...
        termination.start(0L, InnerScore.of(SimpleScore.ZERO));
        assertThat(termination.isTerminated(10 * NANOS_PER_MILLISECOND, InnerScore.of(SimpleScore.ZERO))).isTrue();
    }
    ...
    void testTerminatesWhenScoreDoesNotImprove() {
        var termination = new DiminishedReturnsTermination<Object, SimpleScore>(10, 1);
        termination.start(0L, InnerScore.of(SimpleScore.ZERO));
        assertThat(termination.isTerminated(10 * NANOS_PER_MILLISECOND, InnerScore.of(SimpleScore.ONE))).isFalse();

        // Y_0 is 1 - 0 = 1
        var score = InnerScore.of(SimpleScore.of(2));
        ...
        termination.start(0L, InnerScore.of(SimpleScore.ONE));
        termination.step(NANOS_PER_MILLISECOND, InnerScore.of(SimpleScore.ONE));
        // End the grace period
        assertThat(termination.isTerminated(10 * NANOS_PER_MILLISECOND, InnerScore.of(SimpleScore.ONE))).isTrue();
        // Second call bypass the time window verification and must be consistent
        assertThat(termination.isTerminated(11 * NANOS_PER_MILLISECOND, InnerScore.of(SimpleScore.ONE))).isTrue();
    }
    ...
    void testTerminatesWhenImprovementDoesNotMeetCriteria() {
        ...
        score = InnerScore.of(SimpleScore.of(4));
        termination.step(11 * NANOS_PER_MILLISECOND, score);
        ...
        score = InnerScore.of(SimpleScore.of(6));
        ...
        score = InnerScore.of(SimpleScore.of(7));
        termination.step(21 * NANOS_PER_MILLISECOND, score);
    ...
    void testImprovementInInitScoreResetsGrace() {
        ...
        var score = InnerScore.ofUninitialized(SimpleScore.of(0), 1);
        termination.start(0L, score);

        score = InnerScore.ofUninitialized(SimpleScore.of(1), 1);
        assertThat(termination.isTerminated(10 * NANOS_PER_MILLISECOND, score)).isFalse();
        // Y_0 is 1 - 0 = 1

        score = InnerScore.ofUninitialized(SimpleScore.of(2), 1);
        termination.step(11 * NANOS_PER_MILLISECOND, score);
        ...
        score = InnerScore.of(SimpleScore.of(2));
        termination.step(21 * NANOS_PER_MILLISECOND, score);
        ...
        score = InnerScore.of(SimpleScore.of(5));
        termination.step(31 * NANOS_PER_MILLISECOND, score);
    ...
    void testImprovementInHardScoreResetsGrace() {
        ...
        var score = InnerScore.of(HardSoftScore.of(-1, 0));
        termination.start(0L, score);

        score = InnerScore.of(HardSoftScore.of(-1, 1));
        assertThat(termination.isTerminated(10 * NANOS_PER_MILLISECOND, score)).isFalse();
        // Y_0 is 1 - 0 = 1

        score = InnerScore.of(HardSoftScore.of(-1, 2));
        termination.step(11 * NANOS_PER_MILLISECOND, score);
        ...
        score = InnerScore.of(HardSoftScore.of(0, 2));
        termination.step(21 * NANOS_PER_MILLISECOND, score);
        ...
        score = InnerScore.of(HardSoftScore.of(0, 4));
        termination.step(31 * NANOS_PER_MILLISECOND, score);
        ...
        score = InnerScore.of(HardSoftScore.of(0, 5));
        termination.step(31 * NANOS_PER_MILLISECOND, score);
        // This will compare as 5 - 4 = 1, 1 / 2 < 1, so terminate
        assertThat(termination.isTerminated(41 * NANOS_PER_MILLISECOND, score)).isTrue();
    }
    ...
    void testImprovementInInitScoreDuringGrace() {
        ...
        var score = InnerScore.ofUninitialized(SimpleScore.ZERO, 1);
        termination.start(0, score);

        score = InnerScore.of(SimpleScore.of(-1));
        termination.step(5 * NANOS_PER_MILLISECOND, score);
        assertThat(termination.isTerminated(5 * NANOS_PER_MILLISECOND, score)).isFalse();

        score = InnerScore.of(SimpleScore.ZERO);
        termination.step(10 * NANOS_PER_MILLISECOND, score);
        assertThat(termination.isTerminated(10 * NANOS_PER_MILLISECOND, score)).isFalse();

        score = InnerScore.of(SimpleScore.ONE);
        termination.step(15 * NANOS_PER_MILLISECOND, score);
        assertThat(termination.isTerminated(15 * NANOS_PER_MILLISECOND, score)).isFalse();
