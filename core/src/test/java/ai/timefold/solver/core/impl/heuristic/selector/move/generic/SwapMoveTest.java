...
class SwapMoveTest {
    ...
    void isMoveDoableValueRangeProviderOnEntity() {
        ...
        var abMove = new SwapMove<>(entityDescriptor.getGenuineVariableDescriptorList(), a, b, true);
        a.setValue(v1);
        b.setValue(v2);
        ...
        var acMove = new SwapMove<>(entityDescriptor.getGenuineVariableDescriptorList(), a, c, true);
        a.setValue(v1);
        c.setValue(v4);
        ...
        var bcMove = new SwapMove<>(entityDescriptor.getGenuineVariableDescriptorList(), b, c, true);
        b.setValue(v2);
        c.setValue(v4);
