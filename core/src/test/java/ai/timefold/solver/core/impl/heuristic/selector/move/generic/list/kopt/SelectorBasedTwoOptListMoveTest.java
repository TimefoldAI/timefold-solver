...
class SelectorBasedTwoOptListMoveTest {
    ...
    void doMove() {
        ...
        var e1 = new TestdataListEntity("e1", v1, v2, v5, v4, v3, v6, v7, v8);
    ...
    void isMoveDoable() {
        ...
        // 2-Opt((v2, v3), (v2, v3))
        move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e1, 2, 2);
        assertThat(move.isMoveDoable(scoreDirector)).isFalse();

        // 2-Opt((v2, v3), (v3, v4))
        move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e1, 2, 3);
        assertThat(move.isMoveDoable(scoreDirector)).isFalse();

        // 2-Opt((v2, v3), (v4, v5))
        move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e1, 2, 4);
        assertThat(move.isMoveDoable(scoreDirector)).isTrue();

        // 2-Opt((v2, v3), (v1, v2))
        move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e1, 2, 1);
        assertThat(move.isMoveDoable(scoreDirector)).isTrue();
    }
    ...
    void isMoveDoableValueRangeProviderOnEntity() {
        ...
        assertThat(
                new SelectorBasedTwoOptListMove<>(otherVariableDescriptor, e1, e2, 1, 1).isMoveDoable(otherInnerScoreDirector))
                .isTrue();
        // different entity => invalid left
        assertThat(
                new SelectorBasedTwoOptListMove<>(otherVariableDescriptor, e1, e2, 0, 1).isMoveDoable(otherInnerScoreDirector))
                .isFalse();
        // different entity => invalid right
        assertThat(
                new SelectorBasedTwoOptListMove<>(otherVariableDescriptor, e1, e2, 1, 0).isMoveDoable(otherInnerScoreDirector))
                .isFalse();
    }
    ...
    void isMoveDoableTailSwap() {
        ...
        var v7 = new TestdataListValue("7");
        var v8 = new TestdataListValue("8");
        var v9 = new TestdataListValue("9");
        var e1 = new TestdataListEntity("e1", v1, v2, v3, v4);
        var e2 = new TestdataListEntity("e2", v5, v6, v7, v8, v9);

        // 2-Opt((v2, v3), (v6, v7))
        var move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e2, 2, 2);
        assertThat(move.isMoveDoable(scoreDirector)).isTrue();

        move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e2, 1, 2);
        assertThat(move.isMoveDoable(scoreDirector)).isTrue();

        move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e2, 2, 1);
        assertThat(move.isMoveDoable(scoreDirector)).isTrue();
    }
    ...
    void doMoveSecondEndsBeforeFirst() {
        ...
        var v7 = new TestdataListValue("7");
        var v8 = new TestdataListValue("8");
        var e1 = new TestdataListEntity("e1", v8, v7, v3, v4, v5, v6, v2, v1);
        var solution = new TestdataListSolution();
        solution.setEntityList(List.of(e1));
        solution.setValueList(List.of(v1, v2, v5, v4, v3, v6, v7, v8));
        SolutionManager.updateShadowVariables(solution);
        ...
        // 2-Opt((v6, v2), (v7, v3))
        var move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e1, 6, 2);
        move.execute(scoreDirector);
    ...
    void doMoveSecondEndsBeforeFirstUnbalanced() {
        ...
        var v6 = new TestdataListValue("6");
        var v7 = new TestdataListValue("7");
        var e1 = new TestdataListEntity("e1", v5, v2, v3, v4, v1, v7, v6);
        var solution = new TestdataListSolution();
        solution.setEntityList(List.of(e1));
        ...
        // 2-Opt((v4, v1), (v5, v2))
        var move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e1, 4, 1);
        move.execute(scoreDirector);
    ...
    void doMoveFirstEndsBeforeSecondUnbalanced() {
        ...
        var v6 = new TestdataListValue("6");
        var v7 = new TestdataListValue("7");
        var e1 = new TestdataListEntity("e1", v2, v1, v7, v4, v5, v6, v3);
        var solution = new TestdataListSolution();
        solution.setEntityList(List.of(e1));
        solution.setValueList(List.of(v1, v2, v5, v4, v3, v6, v7));
        SolutionManager.updateShadowVariables(solution);
        ...
        // 2-Opt((v4, v1), (v5, v2))
        var move = new SelectorBasedTwoOptListMove<>(variableDescriptor, e1, e1, 2, 1);
        move.execute(scoreDirector);
    ...
    void doMoveSecondEndsBeforeFirstPinned() {
        ...
        // 2-Opt((v6, v2), (v7, v3))
        var move = new SelectorBasedTwoOptListMove<>(variableDescriptorSpy, e1, e1, 6, 2);
        move.execute(scoreDirector);
    ...
    static void assertSameProperties(Object destinationEntity, int destinationV1, int destinationV2,
            SelectorBasedTwoOptListMove<?> move) {
