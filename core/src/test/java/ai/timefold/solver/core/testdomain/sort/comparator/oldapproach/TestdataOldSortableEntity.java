...
public class TestdataOldSortableEntity extends TestdataObject implements TestSortableObject {
    ...
    public TestdataOldSortableEntity() {
    }

    public TestdataOldSortableEntity(String code, int difficulty) {
        super(code);
