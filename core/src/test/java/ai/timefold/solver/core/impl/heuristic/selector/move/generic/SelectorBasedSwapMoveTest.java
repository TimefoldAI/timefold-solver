...
class SelectorBasedSwapMoveTest {
    ...
    void rebase() {
        ...
        assertSameProperties(destinationE1, destinationE2,
                new SelectorBasedSwapMove<>(variableDescriptorList, e1, e2).rebase(destinationScoreDirector.getMoveDirector()));
        assertSameProperties(destinationE1, destinationE3,
                new SelectorBasedSwapMove<>(variableDescriptorList, e1, e3).rebase(destinationScoreDirector.getMoveDirector()));
        assertSameProperties(destinationE2, destinationE3,
                new SelectorBasedSwapMove<>(variableDescriptorList, e2, e3).rebase(destinationScoreDirector.getMoveDirector()));
    }

    public void assertSameProperties(Object leftEntity, Object rightEntity, SelectorBasedSwapMove<?> move) {
    ...
    void getters() {
        ...
        var move = new SelectorBasedSwapMove<>(Collections.singletonList(primaryDescriptor),
                new TestdataMultiVarEntity("a"), new TestdataMultiVarEntity("b"));
        assertCode("a", move.getLeftEntity());
        assertCode("b", move.getRightEntity());

        move = new SelectorBasedSwapMove<>(Arrays.asList(primaryDescriptor, secondaryDescriptor),
    ...
    void toStringTest() {
        ...
        assertThat(new SelectorBasedSwapMove<>(variableDescriptorList, a, c)).hasToString("a {null} <-> c {v2}");
        assertThat(new SelectorBasedSwapMove<>(variableDescriptorList, b, c)).hasToString("b {v1} <-> c {v2}");
        assertThat(new SelectorBasedSwapMove<>(variableDescriptorList, c, b)).hasToString("c {v2} <-> b {v1}");
    }
    ...
    void toStringTestMultiVar() {
        ...
        assertThat(new SelectorBasedSwapMove<>(variableDescriptorList, b, c)).hasToString("b {v1, v3, w1} <-> c {v2, v4, w2}");
        assertThat(new SelectorBasedSwapMove<>(variableDescriptorList, c, b)).hasToString("c {v2, v4, w2} <-> b {v1, v3, w1}");
    }
