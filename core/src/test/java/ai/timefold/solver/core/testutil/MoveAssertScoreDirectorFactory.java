...
@NullMarked
final class MoveAssertScoreDirectorFactory<Solution_, Score_ extends Score<Score_>>
    ...
    MoveAssertScoreDirectorFactory(SolutionDescriptor<Solution_> solutionDescriptor,
