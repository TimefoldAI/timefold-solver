package ai.timefold.solver.core.impl.testdata.domain.inheritance.single.baseannotated.classes.childtoo;
...
public class TestdataBothAnnotatedSolution {
    ...
    public static TestdataBothAnnotatedSolution generateSolution(int valueListSize, int entityListSize, boolean initialized) {
        ...
        for (int i = 0; i < entityListSize; i++) {
            var entity = new TestdataBothAnnotatedChildEntity(i);
            if (initialized) {
