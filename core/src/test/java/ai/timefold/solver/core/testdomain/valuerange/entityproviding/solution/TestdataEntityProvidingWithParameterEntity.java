...
public class TestdataEntityProvidingWithParameterEntity extends TestdataObject {
    ...
    public static EntityDescriptor<TestdataEntityProvidingWithParameterSolution> buildEntityDescriptor() {
    ...
    public static GenuineVariableDescriptor<TestdataEntityProvidingWithParameterSolution> buildVariableDescriptorForValue() {
    ...
    public TestdataEntityProvidingWithParameterEntity(String code, List<TestdataValue> valueRange, TestdataValue value) {
        super(code);
