...
final class InnerBiConstraintCollectorsTest extends AbstractConstraintCollectorsTest {
    ...
    public void loadBalance() {
        BiConstraintCollector<Integer, Integer, ?, LoadBalance> collector =
                ConstraintCollectors.loadBalance(Integer::sum);
        Object container = collector.supplier().get();
    ...
    private static <A, B, Container_> void assertUnfairness(
            BiConstraintCollector<A, B, Container_, LoadBalance> collector, Object container, BigDecimal expectedResult) {
        var actualResult = collector.finisher().apply((Container_) container);
