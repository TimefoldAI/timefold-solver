package ai.timefold.solver.core.impl.bavet.common.index.joiner;

import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.CONTAINING;
import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.DISJOINT;
import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.EQUAL;
import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.GREATER_THAN;
import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.GREATER_THAN_OR_EQUAL;
import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.INTERSECTING;
import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.LESS_THAN;
import static ai.timefold.solver.core.impl.bavet.common.index.joiner.JoinerType.LESS_THAN_OR_EQUAL;
