...
public class TestdataNewSortableEntity extends TestdataObject implements TestSortableObject {
    ...
    public TestdataNewSortableEntity(String code, int difficulty) {
        super(code);
