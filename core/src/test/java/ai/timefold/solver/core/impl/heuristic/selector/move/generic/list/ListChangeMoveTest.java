...
class ListChangeMoveTest {
    ...
    void isMoveDoableValueRangeProviderOnEntity() {
        ...
        assertThat(new ListChangeMove<>(otherVariableDescriptor, entity1, 0, entity2, 0, true).isMoveDoable(otherInnerScoreDirector))
                .isTrue();
        // different entity => invalid value
        assertThat(new ListChangeMove<>(otherVariableDescriptor, entity1, 1, entity2, 0, true).isMoveDoable(otherInnerScoreDirector))
                .isFalse();
    }
