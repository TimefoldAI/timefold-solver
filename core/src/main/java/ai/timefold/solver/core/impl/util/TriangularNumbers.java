...
public final class TriangularNumbers {
     ...
     * To be able to use {@code int} arithmetic to calculate the triangular number,
     * <em>n</em> must be less than or equal to {@link #HIGHEST_SAFE_N}.
     * If the <em>n</em> is higher, the method throws an exception.
     *
