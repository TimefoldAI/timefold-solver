 ...
 * Call {@link #resetEntityValueRange(Object)} every time an entity is changed,
 * so that the cached value range can be invalidated.
 */
@NullMarked
final class ValueRangeState<Solution_> {
    ...
    public void resetEntityValueRange(Object entity) {
        fromEntityValueRangeMap.remove(entity);
    }
