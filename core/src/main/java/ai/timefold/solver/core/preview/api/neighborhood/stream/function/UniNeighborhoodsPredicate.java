 ...
 */
@NullMarked
public interface UniNeighborhoodsPredicate<Solution_, A> extends BiPredicate<SolutionView<Solution_>, A> {

    @Override
    boolean test(SolutionView<Solution_> solutionView, @Nullable A a);

    @Override
    default UniNeighborhoodsPredicate<Solution_, A> and(BiPredicate<? super SolutionView<Solution_>, ? super A> other) {
