...
@NullMarked
public final class PrefilterQuadNode<A, B, C, D>
        extends AbstractPrefilterNode<QuadTuple<A, B, C, D>> {

    private final QuadPredicate<A, B, C, D> predicate;

    public PrefilterQuadNode(int inputStoreIndex, QuadPredicate<A, B, C, D> predicate,
