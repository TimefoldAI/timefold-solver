 ...
 * {@link BasicVariableListener}.
 *
 * @param <Solution_> the solution type, the class with the {@link PlanningSolution} annotation
 */
final class VariableListenerNotifiable<Solution_> extends
        AbstractNotifiable<Solution_, BasicVariableChangeEvent<Object>, BasicVariableListener<Solution_, Object>> {

    VariableListenerNotifiable(
            InnerScoreDirector<Solution_, ?> scoreDirector,
            BasicVariableListener<Solution_, Object> variableListener,
            Collection<Notification<Solution_, BasicVariableChangeEvent<Object>, BasicVariableListener<Solution_, Object>>> notificationQueue,
            int globalOrder) {
