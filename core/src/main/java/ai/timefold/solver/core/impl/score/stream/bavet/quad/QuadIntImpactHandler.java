...
record QuadIntImpactHandler<A, B, C, D>(ToIntQuadFunction<A, B, C, D> matchWeigher)
    ...
    public ScoreImpact<?> impactNaked(WeightedScoreImpacter<?, ?> impacter, QuadTuple<A, B, C, D> tuple) {
        return impacter.impactScore(matchWeigher.applyAsInt(tuple.getA(), tuple.getB(), tuple.getC(), tuple.getD()), null);
    }

    @Override
    public ScoreImpact<?> impactWithoutJustification(WeightedScoreImpacter<?, ?> impacter,
            QuadTuple<A, B, C, D> tuple) {
        return impacter.impactScore(matchWeigher.applyAsInt(tuple.getA(), tuple.getB(), tuple.getC(), tuple.getD()),
    ...
    public ScoreImpact<?> impactFull(WeightedScoreImpacter<?, ?> impacter, QuadTuple<A, B, C, D> tuple) {
        ...
        return impacter.impactScore(matchWeigher.applyAsInt(a, b, c, d),
