 ...
 */
@NullMarked
public final class SelectorBasedTwoOptListMove<Solution_> extends AbstractSelectorBasedMove<Solution_> {
    ...
    public boolean isMoveDoable(ScoreDirector<Solution_> scoreDirector) {
        ...
        var firstValueRange = valueRangeManager.getFromEntity(variableDescriptor.getValueRangeDescriptor(), firstEntity);
        var firstListVariable = variableDescriptor.getValue(firstEntity);
    ...
    public String toString() {
        return "2-Opt(firstEntity=" + firstEntity + ", secondEntity=" + secondEntity + ", firstEndpointIndex="
                + firstEdgeEndpoint + ", secondEndpointIndex=" + secondEdgeEndpoint + ")";
    }
}
