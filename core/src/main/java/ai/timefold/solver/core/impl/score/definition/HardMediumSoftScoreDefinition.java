...
public class HardMediumSoftScoreDefinition extends AbstractScoreDefinition<HardMediumSoftScore> {
    ...
    private static final HardMediumSoftScore STRUCTURALLY_FLAWED_SCORE = new HardMediumSoftScore(-1L, 0L, 0L, 0L);
    ...
    @Override
    public HardMediumSoftScore getStructurallyFlawedScore() {
    ...
    public HardMediumSoftScore fromLevelNumbers(Number[] levelNumbers) {
        ...
        return HardMediumSoftScore.of((Long) levelNumbers[0], (Long) levelNumbers[1], (Long) levelNumbers[2]);
    }
    ...
    @Override
    public HardMediumSoftScore divideBySanitizedDivisor(HardMediumSoftScore dividend,
            HardMediumSoftScore divisor) {
