 ...
 */
@NullMarked
public final class SelectorBasedKOptListMove<Solution_> extends AbstractSelectorBasedMove<Solution_> {
    ...
    SelectorBasedKOptListMove(ListVariableDescriptor<Solution_> listVariableDescriptor, KOptDescriptor<?> descriptor,
            MultipleDelegateList<?> combinedList, List<FlipSublistAction> equivalent2Opts, int postShiftAmount,
            int[] newEndIndices) {
        ...
        if (equivalent2Opts.isEmpty()) {
            ...
            var currentAffectedElements = equivalent2Opts.getFirst().getAffectedElements();
    ...
    private SelectorBasedKOptListMove(ListVariableDescriptor<Solution_> listVariableDescriptor, KOptDescriptor<?> descriptor,
            List<FlipSublistAction> equivalent2Opts, int postShiftAmount, int[] newEndIndices, Object[] originalEntities) {
        this.listVariableDescriptor = listVariableDescriptor;
        this.descriptor = descriptor;
        this.equivalent2Opts = equivalent2Opts;
        this.postShiftAmount = postShiftAmount;
    ...
    protected void execute(VariableDescriptorAwareScoreDirector<Solution_> scoreDirector) {
        ...
        combinedList.actOnAffectedElements(listVariableDescriptor, originalEntities,
                (entity, start, end) -> scoreDirector.beforeListVariableChanged(listVariableDescriptor, entity, start, end));
        ...
        combinedList.actOnAffectedElements(listVariableDescriptor, originalEntities,
                (entity, start, end) -> scoreDirector.afterListVariableChanged(listVariableDescriptor, entity, start, end));
    }
    ...
    public SelectorBasedKOptListMove<Solution_> rebase(Lookup lookup) {
        ...
        return new SelectorBasedKOptListMove<>(listVariableDescriptor, descriptor, rebasedEquivalent2Opts, postShiftAmount,
                newEndIndices, newEntities);
    }
