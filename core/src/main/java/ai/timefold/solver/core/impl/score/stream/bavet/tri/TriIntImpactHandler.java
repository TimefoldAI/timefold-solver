...
record TriIntImpactHandler<A, B, C>(ToIntTriFunction<A, B, C> matchWeigher)
    ...
    public ScoreImpact<?> impactNaked(WeightedScoreImpacter<?, ?> impacter, TriTuple<A, B, C> tuple) {
        return impacter.impactScore(matchWeigher.applyAsInt(tuple.getA(), tuple.getB(), tuple.getC()), null);
    }

    @Override
    public ScoreImpact<?> impactWithoutJustification(WeightedScoreImpacter<?, ?> impacter, TriTuple<A, B, C> tuple) {
        return impacter.impactScore(matchWeigher.applyAsInt(tuple.getA(), tuple.getB(), tuple.getC()),
    ...
    public ScoreImpact<?> impactFull(WeightedScoreImpacter<?, ?> impacter, TriTuple<A, B, C> tuple) {
        ...
        return impacter.impactScore(matchWeigher.applyAsInt(a, b, c),
