...
public final class ShadowVariableCalculation<Solution_, Entity_, Value_> {
    ...
    private final InnerVariableReference<Solution_, Entity_, ?>[] inputs;
    ...
    public ShadowVariableCalculation(DefaultShadowVariableFactory<Solution_> shadowVariableFactory,
            InnerVariableReference<Solution_, Entity_, ?>[] inputs, Method calculatorMethod,
            Object calculator) {
    ...
    public ShadowVariableCalculation(ShadowVariableCalculation<Solution_, Entity_, Value_> fallback,
            InnerVariableReference<Solution_, Entity_, ?>[] inputs, Method calculatorMethod, Object calculator) {
