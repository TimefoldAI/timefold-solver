...
public class IndexerFactory<Right_> {
    ...
    public <A> UniMapping<A> buildUniLeftMapping() {
        ...
        return switch (joinerCount) {
            case 0 -> a -> IndexProperties.EMPTY;
    ...
    public <A, B> BiMapping<A, B> buildBiLeftMapping() {
        ...
        return switch (joinerCount) {
            case 0 -> (a, b) -> IndexProperties.EMPTY;
            case 1 -> wrap(castJoiner.getLeftMapping(0));
            default -> {
                var startIndexInclusive = 0;
    ...
    public <A, B, C> TriMapping<A, B, C> buildTriLeftMapping() {
        ...
        return switch (joinerCount) {
            case 0 -> (a, b, c) -> IndexProperties.EMPTY;
            case 1 -> wrap(castJoiner.getLeftMapping(0));
            default -> {
                var startIndexInclusive = 0;
    ...
    public <A, B, C, D> QuadMapping<A, B, C, D> buildQuadLeftMapping() {
        ...
        return switch (joinerCount) {
            case 0 -> (a, b, c, d) -> IndexProperties.EMPTY;
            case 1 -> wrap(castJoiner.getLeftMapping(0));
            default -> {
                var startIndexInclusive = 0;
    ...
    private static <A> UniMapping<A> wrap(Function<A, Object> mapping) {
        return a -> SingleIndexProperties.of(mapping.apply(a));
    }

    private static <A, B> BiMapping<A, B> wrap(BiFunction<A, B, Object> mapping) {
        return (a, b) -> SingleIndexProperties.of(mapping.apply(a, b));
    }

    private static <A, B, C> TriMapping<A, B, C> wrap(TriFunction<A, B, C, Object> mapping) {
        return (a, b, c) -> SingleIndexProperties.of(mapping.apply(a, b, c));
    }

    private static <A, B, C, D> QuadMapping<A, B, C, D> wrap(QuadFunction<A, B, C, D, Object> mapping) {
        return (a, b, c, d) -> SingleIndexProperties.of(mapping.apply(a, b, c, d));
    }

    @FunctionalInterface
    public interface UniMapping<A> extends Function<A, IndexProperties> {
    }

    @FunctionalInterface
    public interface BiMapping<A, B> extends BiFunction<A, B, IndexProperties> {
    }

    @FunctionalInterface
    public interface TriMapping<A, B, C> extends TriFunction<A, B, C, IndexProperties> {
    }

    @FunctionalInterface
    public interface QuadMapping<A, B, C, D> extends QuadFunction<A, B, C, D, IndexProperties> {
    }
