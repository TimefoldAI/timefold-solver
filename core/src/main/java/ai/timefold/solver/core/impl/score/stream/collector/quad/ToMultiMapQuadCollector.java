...
final class ToMultiMapQuadCollector<A, B, C, D, Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
        extends
        UndoableActionableQuadCollector<A, B, C, D, Pair<Key_, Value_>, Result_, MapUndoableActionable.State<Key_, Value_, Set_, Result_>, MapUndoableActionable<Key_, Value_, Set_, Result_>> {
