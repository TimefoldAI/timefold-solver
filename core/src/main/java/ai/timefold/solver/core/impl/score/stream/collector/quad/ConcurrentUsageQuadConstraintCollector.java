...
final class ConcurrentUsageQuadConstraintCollector<A, B, C, D, Interval_, Point_ extends Comparable<Point_>, Difference_ extends Comparable<Difference_>>
        extends
        ObjectCalculatorQuadCollector<A, B, C, D, Interval_, ConcurrentUsageInfo<Interval_, Point_, Difference_>, ConcurrentUsageCalculator<Interval_, Point_, Difference_>> {
    ...
    public ConcurrentUsageQuadConstraintCollector(
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof ConcurrentUsageQuadConstraintCollector<?, ?, ?, ?, ?, ?, ?> that))
            return false;
        if (!super.equals(o))
            return false;
