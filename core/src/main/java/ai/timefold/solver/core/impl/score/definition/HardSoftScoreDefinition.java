...
public class HardSoftScoreDefinition extends AbstractScoreDefinition<HardSoftScore> {
    ...
    @Override
    public HardSoftScore buildOptimisticBound(InitializingScoreTrend initializingScoreTrend,
            HardSoftScore score) {
    ...
    @Override
    public HardSoftScore buildPessimisticBound(InitializingScoreTrend initializingScoreTrend,
            HardSoftScore score) {
        var trendLevels = initializingScoreTrend.trendLevels();
        return HardSoftScore.of(trendLevels[0] == InitializingScoreTrendLevel.ONLY_UP ? score.hardScore() : Long.MIN_VALUE,
