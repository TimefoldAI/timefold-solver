...
final class IntWeightedScoreImpacter<Context_ extends ScoreContext<?, ?>>
        implements WeightedScoreImpacter<Context_> {

    private final IntImpactFunction<Context_> impactFunction;
    private final Context_ context;

    public IntWeightedScoreImpacter(IntImpactFunction<Context_> impactFunction, Context_ context) {
