...
public final class QuadComposeFourCollector<A, B, C, D, ResultHolder1_, ResultHolder2_, ResultHolder3_, ResultHolder4_, Result1_, Result2_, Result3_, Result4_, Result>
    ...
    public QuadComposeFourCollector(QuadConstraintCollector<A, B, C, D, ResultHolder1_, Result1_> first,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        QuadComposeFourCollector<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> that =
                (QuadComposeFourCollector<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>) object;
