...
public final class ComparatorMinTriCollector<A, B, C, Result_>
    ...
    public ComparatorMinTriCollector(TriFunction<? super A, ? super B, ? super C, ? extends Result_> mapper,
    ...
    public boolean equals(Object object) {
        ...
        if (!super.equals(object))
            return false;
        ComparatorMinTriCollector<?, ?, ?, ?> that = (ComparatorMinTriCollector<?, ?, ?, ?>) object;
