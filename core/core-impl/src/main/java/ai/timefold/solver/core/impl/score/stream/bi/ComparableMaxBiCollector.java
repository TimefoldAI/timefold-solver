...
public final class ComparableMaxBiCollector<A, B, Result_ extends Comparable<? super Result_>>
        extends UndoableActionableBiCollector<A, B, Result_, Result_, MinMaxUndoableActionable<Result_, Result_>> {
    public ComparableMaxBiCollector(BiFunction<? super A, ? super B, ? extends Result_> mapper) {
        super(mapper);
    }
