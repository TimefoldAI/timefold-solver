...
public final class IntSumTriCollector<A, B, C> extends IntCalculatorTriCollector<A, B, C, Integer, IntSumCalculator> {
    public IntSumTriCollector(ToIntTriFunction<? super A, ? super B, ? super C> mapper) {
        super(mapper);
    }
