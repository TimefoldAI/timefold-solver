...
public final class MultiMapQuadCollector<A, B, C, D, Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
        extends
    ...
    public MultiMapQuadCollector(QuadFunction<? super A, ? super B, ? super C, ? super D, ? extends Key_> keyFunction,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        MultiMapQuadCollector<?, ?, ?, ?, ?, ?, ?, ?> that =
                (MultiMapQuadCollector<?, ?, ?, ?, ?, ?, ?, ?>) object;
