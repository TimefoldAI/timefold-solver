...
public final class MultiMapTriCollector<A, B, C, Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
        extends
    ...
    public MultiMapTriCollector(TriFunction<? super A, ? super B, ? super C, ? extends Key_> keyFunction,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        MultiMapTriCollector<?, ?, ?, ?, ?, ?, ?> that = (MultiMapTriCollector<?, ?, ?, ?, ?, ?, ?>) object;
