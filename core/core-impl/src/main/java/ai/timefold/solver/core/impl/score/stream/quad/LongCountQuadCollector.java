...
public final class LongCountQuadCollector<A, B, C, D> implements QuadConstraintCollector<A, B, C, D, LongCounter, Long> {
    @Override
    ...
    public boolean equals(Object o) {
        return o instanceof LongCountQuadCollector;
    }
