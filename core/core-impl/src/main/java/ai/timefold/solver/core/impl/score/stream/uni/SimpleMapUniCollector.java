...
public final class SimpleMapUniCollector<A, Key_, Value_, Result_ extends Map<Key_, Value_>>
        extends
    ...
    public SimpleMapUniCollector(Function<? super A, ? extends Key_> keyFunction,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        SimpleMapUniCollector<?, ?, ?, ?> that = (SimpleMapUniCollector<?, ?, ?, ?>) object;
