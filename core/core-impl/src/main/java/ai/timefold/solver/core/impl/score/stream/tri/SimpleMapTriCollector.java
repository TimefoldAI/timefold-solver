...
public final class SimpleMapTriCollector<A, B, C, Key_, Value_, Result_ extends Map<Key_, Value_>>
        extends
    ...
    public SimpleMapTriCollector(TriFunction<? super A, ? super B, ? super C, ? extends Key_> keyFunction,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        SimpleMapTriCollector<?, ?, ?, ?, ?, ?> that = (SimpleMapTriCollector<?, ?, ?, ?, ?, ?>) object;
