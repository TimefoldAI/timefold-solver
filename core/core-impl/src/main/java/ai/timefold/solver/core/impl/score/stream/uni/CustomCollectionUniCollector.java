...
public final class CustomCollectionUniCollector<A, Mapped_, Result_ extends Collection<Mapped_>>
    ...
    public CustomCollectionUniCollector(Function<? super A, ? extends Mapped_> mapper,
