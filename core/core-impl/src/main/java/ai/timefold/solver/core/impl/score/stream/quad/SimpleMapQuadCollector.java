...
public final class SimpleMapQuadCollector<A, B, C, D, Key_, Value_, Result_ extends Map<Key_, Value_>>
        extends
    ...
    public SimpleMapQuadCollector(QuadFunction<? super A, ? super B, ? super C, ? super D, ? extends Key_> keyFunction,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        SimpleMapQuadCollector<?, ?, ?, ?, ?, ?, ?> that = (SimpleMapQuadCollector<?, ?, ?, ?, ?, ?, ?>) object;
