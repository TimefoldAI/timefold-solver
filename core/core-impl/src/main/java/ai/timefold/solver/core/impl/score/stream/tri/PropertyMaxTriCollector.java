...
public final class PropertyMaxTriCollector<A, B, C, Result_, Property_ extends Comparable<? super Property_>>
    ...
    public PropertyMaxTriCollector(TriFunction<? super A, ? super B, ? super C, ? extends Result_> mapper,
