...
/**
 * Specifies that an {@link Integer} property (or field) of a {@link PlanningEntity} determines
 ...
 *
 * <ul>
 * <li>-1 (or null): Pinning is disabled.
 ...
 *
 * <ul>
 * <li>-1 or null allows the entire list to be modified.</li>
 * <li>0 pins {@code A}; rest of the list may be modified or added to.</li>
 * <li>1 pins {@code A, B}; rest of the list may be modified or added to.</li>
 * <li>2 pins {@code A, B, C}; the list can only be added to.</li>
 * <li>3 fails fast as there is no such index in the list.</li>
 * </ul>
 *
 * If the same entity also specifies a {@link PlanningPin} and the pin is enabled,
 * any value of {@link PlanningPinIndex} is ignored.
 * In other words, enabling {@link PlanningPin} pins the entire list without exception.
 */
@Target({ METHOD, FIELD })
@Retention(RUNTIME)
public @interface PlanningPinIndex {
