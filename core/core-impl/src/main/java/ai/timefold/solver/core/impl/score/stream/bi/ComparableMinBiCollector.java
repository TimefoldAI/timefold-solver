...
public final class ComparableMinBiCollector<A, B, Result extends Comparable<? super Result>>
        extends UndoableActionableBiCollector<A, B, Result, Result, MinMaxUndoableActionable<Result, Result>> {
    public ComparableMinBiCollector(BiFunction<? super A, ? super B, ? extends Result> mapper) {
        super(mapper);
    }
