...
public final class ComparableMinTriCollector<A, B, C, Result_ extends Comparable<? super Result_>>
        extends UndoableActionableTriCollector<A, B, C, Result_, Result_, MinMaxUndoableActionable<Result_, Result_>> {
    public ComparableMinTriCollector(TriFunction<? super A, ? super B, ? super C, ? extends Result_> mapper) {
        super(mapper);
    }
