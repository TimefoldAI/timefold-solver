...
public final class CustomCollectionTriCollector<A, B, C, Mapped_, Result_ extends Collection<Mapped_>>
        extends
    ...
    public CustomCollectionTriCollector(TriFunction<? super A, ? super B, ? super C, ? extends Mapped_> mapper,
