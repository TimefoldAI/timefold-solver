...
public final class MultiMapUniCollector<A, Key_, Value_, Set_ extends Set<Value_>, Result_ extends Map<Key_, Set_>>
        extends
    ...
    public MultiMapUniCollector(Function<? super A, ? extends Key_> keyFunction,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        MultiMapUniCollector<?, ?, ?, ?, ?> that = (MultiMapUniCollector<?, ?, ?, ?, ?>) object;
