...
public final class ComparatorMaxQuadCollector<A, B, C, D, Result_>
    ...
    public ComparatorMaxQuadCollector(QuadFunction<? super A, ? super B, ? super C, ? super D, ? extends Result_> mapper,
