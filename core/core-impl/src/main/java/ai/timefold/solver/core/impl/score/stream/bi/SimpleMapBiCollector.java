...
public final class SimpleMapBiCollector<A, B, Key_, Value_, Result_ extends Map<Key_, Value_>>
        extends
    ...
    public SimpleMapBiCollector(BiFunction<? super A, ? super B, ? extends Key_> keyFunction,
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        SimpleMapBiCollector<?, ?, ?, ?, ?> that = (SimpleMapBiCollector<?, ?, ?, ?, ?>) object;
