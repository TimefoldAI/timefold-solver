...
import ai.timefold.solver.core.impl.testdata.domain.inheritance.entity.single.baseannotated.interfaces.addvar.TestdataAddVarInterfaceBaseEntity;
...
class TimefoldProcessorAddVarInterfaceTest {

    @RegisterExtension
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            .overrideConfigKey("quarkus.timefold.solver.termination.best-score-limit", "0")
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(TestAddVarInterfaceConstraintProvider.class, TestdataAddVarInterfaceSolution.class,
                            TestdataAddVarInterfaceChildEntity.class,
                            TestdataAddVarInterfaceBaseEntity.class));
    @Inject
    SolverFactory<TestdataAddVarInterfaceSolution> solverFactory;
