...
import ai.timefold.solver.quarkus.jackson.api.domain.solution.ConstraintWeightOverridesSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.PolymorphicScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.PolymorphicScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.analysis.ScoreAnalysisJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.bendable.BendableScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.bendable.BendableScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.bendablebigdecimal.BendableBigDecimalScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.bendablebigdecimal.BendableBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.bendablelong.BendableLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.bendablelong.BendableLongScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardmediumsoft.HardMediumSoftScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardmediumsoft.HardMediumSoftScoreJsonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardmediumsoftbigdecimal.HardMediumSoftBigDecimalScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardmediumsoftbigdecimal.HardMediumSoftBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardmediumsoftlong.HardMediumSoftLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardmediumsoftlong.HardMediumSoftLongScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardsoft.HardSoftScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardsoft.HardSoftScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardsoftbigdecimal.HardSoftBigDecimalScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardsoftbigdecimal.HardSoftBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardsoftlong.HardSoftLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.hardsoftlong.HardSoftLongScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.simple.SimpleScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.simple.SimpleScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.simplebigdecimal.SimpleBigDecimalScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.simplebigdecimal.SimpleBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.simplelong.SimpleLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.buildin.simplelong.SimpleLongScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.constraint.ConstraintRefJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.constraint.ConstraintRefJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.BreakJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.BreakJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.LoadBalanceJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.LoadBalanceJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.SequenceChainJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.SequenceChainJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.SequenceJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.api.score.stream.common.SequenceJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.solver.RecommendedAssignmentJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.api.solver.RecommendedFitJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.diff.PlanningEntityDiffJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.diff.PlanningSolutionDiffJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.diff.PlanningVariableDiffJacksonSerializer;
