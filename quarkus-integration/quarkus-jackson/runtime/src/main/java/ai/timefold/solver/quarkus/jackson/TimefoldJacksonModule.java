...
import ai.timefold.solver.quarkus.jackson.score.analysis.ScoreAnalysisJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.bendable.BendableScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.bendable.BendableScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.bendablebigdecimal.BendableBigDecimalScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.bendablebigdecimal.BendableBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.bendablelong.BendableLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.bendablelong.BendableLongScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.hardmediumsoft.HardMediumSoftScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.hardmediumsoft.HardMediumSoftScoreJsonSerializer;
...
import ai.timefold.solver.quarkus.jackson.score.buildin.hardmediumsoftbigdecimal.HardMediumSoftBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.hardmediumsoftlong.HardMediumSoftLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.hardmediumsoftlong.HardMediumSoftLongScoreJacksonSerializer;
...
import ai.timefold.solver.quarkus.jackson.score.buildin.hardsoftbigdecimal.HardSoftBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.hardsoftlong.HardSoftLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.hardsoftlong.HardSoftLongScoreJacksonSerializer;
...
import ai.timefold.solver.quarkus.jackson.score.buildin.simplebigdecimal.SimpleBigDecimalScoreJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.simplelong.SimpleLongScoreJacksonDeserializer;
import ai.timefold.solver.quarkus.jackson.score.buildin.simplelong.SimpleLongScoreJacksonSerializer;
...
import ai.timefold.solver.quarkus.jackson.solver.RecommendedAssignmentJacksonSerializer;
import ai.timefold.solver.quarkus.jackson.solver.RecommendedFitJacksonSerializer;
