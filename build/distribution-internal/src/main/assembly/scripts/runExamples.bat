...
set "jvmOptions=-Xms256m -Xmx2g -Dai.timefold.solver.examples.dataDir=examples/sources/data/"
set "mainClass=ai.timefold.solver.examples.app.TimefoldExamplesApp"
