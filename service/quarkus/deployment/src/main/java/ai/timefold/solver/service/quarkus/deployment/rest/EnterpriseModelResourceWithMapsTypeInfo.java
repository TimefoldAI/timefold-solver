...
public class EnterpriseModelResourceWithMapsTypeInfo implements ModelResourceTypeInfo {
    ...
    public String constructorSignature(ModelComponentsBuildItem modelComponents) {
        return SignatureBuilder.forMethod()
                .addParameterType(Type.classType(SCORE_ANALYSIS_FACADE_BASE.toString()))
