...
class TimefoldStorageProcessor {
    ...
    /**
     * Generating concrete implementation of <code>ai.timefold.solver.service.api.storage.Storage<ModelOutput_></code> based on
     * project dependency with underlying object store such as S3, Google Cloud Storage or Azure BlobStore.
     * <p>
     * Looks up what implements the <code>ai.timefold.solver.service.api.ModelOutput</code> and uses it as the actual type of
     * data
     * to be stored.
     *
