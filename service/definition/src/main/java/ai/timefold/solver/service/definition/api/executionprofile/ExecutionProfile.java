 ...
 * Implementations are discovered as CDI beans, so a new profile can be added simply by providing a new implementation - no
 * central registry needs to be edited. A run may activate several profiles at once.
 */
