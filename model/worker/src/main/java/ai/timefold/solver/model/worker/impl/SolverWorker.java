...
import static ai.timefold.solver.model.definition.internal.error.ErrorCodes.SOLVER_UNKNOWN;
import static ai.timefold.solver.model.definition.internal.platform.EnvironmentVars.ENV_TIMEFOLD_PLAN_NAME;
...
import ai.timefold.solver.model.definition.internal.events.AbstractEvent;
...
import ai.timefold.solver.model.definition.internal.platform.OnStartCommand;
import ai.timefold.solver.model.definition.internal.solver.BestSolutionConsumerDecorator;
import ai.timefold.solver.model.definition.internal.storage.AbstractStorageService;
import ai.timefold.solver.model.worker.impl.termination.TerminationService;
