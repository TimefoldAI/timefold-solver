...
public class SampleConstraintProvider implements ConstraintProvider {
    ...
    public Constraint @NonNull [] defineConstraints(@NonNull ConstraintFactory factory) {
        return new Constraint[] {
                factory.forEach(SampleEntity.class)
                        .join(SampleEntity.class, Joiners.equal(SampleEntity::getValue))
                        .filter((a, b) -> a != b)
